...
cdef extern from "batman.h" namespace "transit":
    cdef cppclass BatmanLimbDarkening:
        BatmanLimbDarkening () except +
...
cdef class CythonSolver:
    ...
    def kepler_gradient(self,
        ...
        if n_body == 0:
            ...
            flag = integrator.gradient[kepler_6](
                <double*>params.data, t.shape[0], <double*>t.data, texp,
                <double*>lc.data, <double*>gradient.data)
        elif n_body == 7:
            flag = integrator.gradient[kepler_7](
                <double*>params.data, t.shape[0], <double*>t.data, texp,
                <double*>lc.data, <double*>gradient.data)
        else:
